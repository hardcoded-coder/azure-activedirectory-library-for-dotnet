...
namespace Microsoft.IdentityModel.Clients.ActiveDirectory
{
    ...
    {
        public AcquireTokenSilentHandler(Authenticator authenticator, TokenCache tokenCache, string[] scopes, ClientKey clientKey, UserIdentifier userId)
            : base(authenticator, tokenCache, scopes, clientKey, clientKey.HasCredential ? TokenSubjectType.UserPlusClient : TokenSubjectType.User)
        {
            if (userId == null)
            {
