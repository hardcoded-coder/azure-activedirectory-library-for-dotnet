...
namespace Microsoft.IdentityModel.Clients.ActiveDirectory
{
    internal abstract class AcquireTokenHandlerBase
    {
        ...
        protected AcquireTokenHandlerBase(Authenticator authenticator, TokenCache tokenCache, string[] scopes, ClientKey clientKey, TokenSubjectType subjectType)
        {
            ...
            PlatformPlugin.Logger.Information(this.CallState,
                ...
                authenticator.Authority, AdalHelpers.CreateSingleStringFromArray(scopes), clientKey.ClientId,
        ...
        public async Task<AuthenticationResult> RunAsync()
        {
            ...
            try
            {
                ...
                if (this.LoadFromCache)
                {
                    ...
                    resultEx = this.tokenCache.LoadFromCache(this.Authenticator.Authority, this.Scopes, this.ClientKey.ClientId, this.TokenSubjectType, this.UniqueId, this.DisplayableId, this.CallState);
                    if (resultEx != null && resultEx.Result.AccessToken == null && resultEx.RefreshToken != null)
                    {
                        ...
                        if (resultEx != null)
                        {
                            this.tokenCache.StoreToCache(resultEx, this.Authenticator.Authority, this.Scopes, this.ClientKey.ClientId, this.TokenSubjectType, this.CallState);
                        }
                    }
                }
        ...
        {
            var requestParameters = new DictionaryRequestParameters(this.Scopes, this.ClientKey);
