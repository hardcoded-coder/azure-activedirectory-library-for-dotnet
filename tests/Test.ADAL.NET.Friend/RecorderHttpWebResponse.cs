...
namespace Test.ADAL.NET.Friend
{
    class RecorderHttpWebResponse : IHttpWebResponse
    {
        ...
        public RecorderHttpWebResponse(Stream responseStream, Dictionary<string, string> headers, HttpStatusCode statusCode, CloseResponseMethod closeResponseMethod)
        {
